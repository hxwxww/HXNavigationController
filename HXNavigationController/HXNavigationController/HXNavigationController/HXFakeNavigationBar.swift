...
class HXFakeNavigationBar: UIView {
    ...
    func hx_updateFakeBarBackground(for viewController: UIViewController) {
        fakeBackgroundEffectView.subviews.last?.backgroundColor = viewController.hx_backgroundColor
        fakeBackgroundImageView.image = viewController.hx_backgroundImage
        if viewController.hx_backgroundImage != nil {
            ...
            fakeBackgroundEffectView.subviews.forEach { (subview) in
                subview.alpha = viewController.hx_barAlpha
            }
        }
        fakeBackgroundImageView.alpha = viewController.hx_barAlpha
        fakeShadowImageView.alpha = viewController.hx_barAlpha
    }
    
    func hx_updateFakeBarShadow(for viewController: UIViewController) {
        fakeShadowImageView.isHidden = viewController.hx_shadowHidden
        fakeShadowImageView.backgroundColor = viewController.hx_shadowColor
    }
