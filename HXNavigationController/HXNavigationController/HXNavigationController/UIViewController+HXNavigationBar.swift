...
extension UIViewController {
    ...
    /// 导航栏背景色，默认白色
    var hx_backgroundColor: UIColor {
        get {
    ...
    /// 导航栏背景图片
    var hx_backgroundImage: UIImage? {
        get {
